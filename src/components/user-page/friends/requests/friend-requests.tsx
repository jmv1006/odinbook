...
import { RequestsContainer, SentRequestsBtn } from "./styles"
...
const FriendRequests = () => {
    ...
    return (
        <RequestsContainer>
            <SentRequestsBtn onClick={toggleSentRequestsModal}>Sent Requests</SentRequestsBtn>
            <div>
                {mappedRequests.length === 0 ? "No Requests!" : mappedRequests}
            </div>
